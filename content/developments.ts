...
export const developments: Development[] = [
  {
    ...
    heroMedia: {
      ...
      alt: "The Emerald — a fully-detached duplex residence",
  ...
  },
  {
    ...
    gallery: [
      { src: "/media/images/dev-citadel-1.jpg", alt: "Citadel Oasis — modern residential community on Abraham Adesanya Road, Ajah", credit: "Conceptual render" },
  ...
  },
  {
    ...
    gallery: [
      { src: "/media/images/dev-capital-1.jpg", alt: "Capital Loft — modern terrace residences", credit: "Conceptual render" },
