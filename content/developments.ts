...
export const developments: Development[] = [
  {
    ...
    status: "AVAILABLE",
    heroMedia: {
      src: "/media/images/emerald-duplex.jpg",
      alt: "Modern fully detached duplex at The Emerald",
      credit: "Conceptual render",
    },
    gallery: [
      { src: "/media/images/emerald-duplex.jpg", alt: "Emerald duplex exterior", credit: "Conceptual render" },
      { src: "/media/images/emerald-interior.jpg", alt: "Emerald duplex living interior", credit: "Conceptual render" },
      { src: "/media/images/home-amenity-pool.jpg", alt: "Emerald community pool", credit: "Conceptual render" },
    ],
  ...
  },
  {
    ...
    heroMedia: {
      ...
      alt: "Secure modern community at Citadel Oasis, Ajah",
      credit: "Conceptual render",
    },
    gallery: [
      { src: "/media/images/citadel-community.jpg", alt: "Citadel Oasis community aerial", credit: "Conceptual render" },
      { src: "/media/images/citadel-interior.jpg", alt: "Citadel Oasis home interior", credit: "Conceptual render" },
      { src: "/media/images/home-amenity-pool.jpg", alt: "Citadel Oasis pool amenity", credit: "Conceptual render" },
    ],
  ...
  },
  {
    ...
    heroMedia: {
      ...
      alt: "Modern terrace residences at Capital Loft",
      credit: "Artist impression",
    },
    gallery: [
      { src: "/media/images/capital-loft.jpg", alt: "Capital Loft terrace exterior", credit: "Artist impression" },
      { src: "/media/images/capital-loft-interior.jpg", alt: "Capital Loft open-plan interior", credit: "Artist impression" },
    ],
...
export const properties: Property[] = [
  {
    ...
    gallery: [
      { src: "/media/images/emerald-duplex.jpg", alt: "Emerald 2 bedroom duplex exterior", credit: "Conceptual render" },
      { src: "/media/images/emerald-interior.jpg", alt: "Emerald living interior", credit: "Conceptual render" },
    ],
    floorPlans: [],
    brochure: null,
    mapCoordinates: null,
  ...
  },
  {
    ...
    gallery: [
      { src: "/media/images/emerald-duplex.jpg", alt: "Emerald 3 bedroom duplex exterior", credit: "Conceptual render" },
      { src: "/media/images/emerald-interior.jpg", alt: "Emerald duplex interior", credit: "Conceptual render" },
      { src: "/media/images/home-amenity-pool.jpg", alt: "Emerald community leisure", credit: "Conceptual render" },
    ],
    floorPlans: [],
    brochure: null,
    mapCoordinates: null,
  ...
  },
  {
    ...
    gallery: [
      { src: "/media/images/emerald-duplex.jpg", alt: "Emerald 4 bedroom duplex exterior", credit: "Conceptual render" },
      { src: "/media/images/emerald-interior.jpg", alt: "Emerald duplex interior", credit: "Conceptual render" },
    ],
    floorPlans: [],
    brochure: null,
  ...
  },
  {
    ...
    gallery: [
      { src: "/media/images/citadel-community.jpg", alt: "Citadel Oasis secure community", credit: "Conceptual render" },
      { src: "/media/images/citadel-interior.jpg", alt: "Citadel Oasis family interior", credit: "Conceptual render" },
      { src: "/media/images/home-amenity-pool.jpg", alt: "Citadel Oasis pool", credit: "Conceptual render" },
    ],
    floorPlans: [],
    brochure: null,
    mapCoordinates: null,
  ...
  },
  {
    ...
    gallery: [
      { src: "/media/images/capital-loft.jpg", alt: "Capital Loft 3 bedroom terrace", credit: "Artist impression" },
      { src: "/media/images/capital-loft-interior.jpg", alt: "Capital Loft interior", credit: "Artist impression" },
    ],
    floorPlans: [],
    brochure: null,
    mapCoordinates: null,
  ...
  },
  {
    ...
    gallery: [
      { src: "/media/images/capital-loft.jpg", alt: "Capital Loft terrace with BQ", credit: "Artist impression" },
      { src: "/media/images/capital-loft-interior.jpg", alt: "Capital Loft interior", credit: "Artist impression" },
    ],
    floorPlans: [],
    brochure: null,
